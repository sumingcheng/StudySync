...
<jsp:useBean id="splBean" class="chfive.SampleBean3" scope="request"/>
<html>
	<head>
	...
	<body>
<%splBean.getNum();%> 
<center><p><font size="5">访问人次：<strong><jsp:include page="sample4.jsp" flush="true"/></strong></font></p></center>
